<template>
  <div class="app-container">
    <el-form :model="queryParams" ref="queryForm" size="small" :inline="true" v-show="showSearch" label-width="68px">
      ...
      <el-form-item label="场景用户ID" prop="sceneUserId">
        <el-input
          v-model="queryParams.sceneUserId"
          placeholder="请输入场景用户ID"
          clearable
          @keyup.enter.native="handleQuery"
        />
      </el-form-item>
    ...
    <el-dialog :title="title" :visible.sync="open" width="500px" append-to-body>
      <el-form ref="form" :model="form" :rules="rules" label-width="80px">
        ...
        <el-form-item label="场景用户ID" prop="sceneUserId">
          <el-input v-model="form.sceneUserId" placeholder="请输入场景用户ID" />
        </el-form-item>
        <el-form-item label="文件名" prop="filename">
...
<script>
import { listFile, getFile, delFile, addFile, updateFile } from "@/api/ai/file";
...
export default {
  ...
  methods: {
    ...
    handleDelete(row) {
      ...
      this.$modal.confirm('是否确认删除file编号为"' + ids + '"的数据项？').then(function() {
        return delFile(ids);
      }).then(() => {
        this.getList();
